...
class BlogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'imagelink' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'imagelink' => 'Lorem ipsum dolor sit amet',
                'comments' => 1,
                'created' => '2019-12-21 22:06:19',
                'modified' => '2019-12-21 22:06:19',
            ],
        ];
        parent::init();
    }
